...
export const midHiProtonDataFields = [
    ...
    {name: "DiffProtonFluxes", dataType: "float32Mtx11by5", size: 220, byteOffset: 260},
...
export const xRayDataFields = [
    ...
    {name: "sps_obs_time", dataType: "doubleMtx1by4", size: 32, byteOffset: 94},
...
export const solarGalacticProtonDataFields = [
    ...
    {name: "T1_DifferentialProtonFluxes", dataType: "float32Mtx6by2", size: 48, byteOffset: 16},
    ...
    {name: "T3_DifferentialProtonFluxes", dataType: "float32Mtx5by2", size: 40, byteOffset: 256},
    ...
    {name: "L1a_SciData_TimeStamp", dataType: "doubleMtx1by2", size: 16, byteOffset: 509},
